...
namespace Clobscode
{
	...
	public:
		...
		virtual bool getLabeled();

		virtual void setLabeled(bool state);
	...
	inline bool MeshPoint::getLabeled()
	{
		return labeled;
	}
	inline void MeshPoint::setLabeled(bool state)
	{
		outsidechecked = state;
	}
